...
import { PINATA_GATEWAY_JWT } from "@/config/config";
...
export default function Home() {
  ...
  async function fetchListings() {
    const data_array = await readFileFromIPFS();
    setListings(data_array);
  }
      ...
      <div className="col">
        <div className="card overflow-hidden rounded-4 shadow-lg" >
          <div className="d-flex flex-column p-3 pb-0 text-shadow-1">
            <img className="overflow-hidden  rounded-4 shadow-lg" src={list.Picture + PINATA_GATEWAY_JWT} style={{maxWidth:'500px', maxHeight:'500px'}}/>
